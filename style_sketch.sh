...
python style_sketch.py --image-size 256 --ckpt "/home/zqchen/code/mask_dit/results/001-mask-0.94-60000-8-myDiT-XL-2/checkpoints/$i.pt"  --num-pattern   8   --hc-path   equ_nv8_vl4_rn1_Bipolar_1x1_norm_GP_RQVQ_level5_256_share_4_9_-1  --catGP=True
